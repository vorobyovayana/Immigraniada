...
<div>
    <h4>APPLICATION TO CHANGE CONDITIONS,<br>EXTEND MY STAY OR REMAIN IN CANADA AS A STUDENT</h4>
</div>
<div>
    ...
    <table class="tg">
        ...
        <tbody>
            <tr>
                <td class="tg-0lax" colspan="2"><span style="font-weight:bold">3. I am applying for one or more of the following: </span><br><br><img src="https://static.thenounproject.com/png/60253-200.png" alt="Image" width="35" height="35">* Apply for a study permit for the first time or extend my study permit&nbsp;&nbsp;&nbsp;&nbsp;<img src="https://static.thenounproject.com/png/60253-200.png" alt="Image" width="35" height="35">* Restore my status as a student&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><img src="https://static.thenounproject.com/png/60253-200.png" alt="Image" width="35" height="35">* Get a new temporary resident permit (for inadmissible applicants only)</td>
            </tr>
        </tbody>
    </table>
    ...
    <b>DETAILS OF INTENDED STUDY IN CANADA</b>
    <table class="tg">
        <thead>
            <tr>
                <th class="tg-0pky" colspan="6">1 I have been accepted at the following educational institution </th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="tg-0pky">* a) Name of School<br><br></td>
                <td class="tg-0pky" colspan="2">* My level of study will be:</td>
                <td class="tg-0pky" colspan="3">My field of study will be: </td>
            </tr>
            <tr>
                <td class="tg-0pky">&nbsp;&nbsp;b) Complete address of school in Canada<br> * Province</td>
                <td class="tg-0pky" colspan="2"><br>* City/Town<br><br></td>
                <td class="tg-0pky" colspan="3"><br>* Address</td>
            </tr>
            <tr>
                <td class="tg-0pky" colspan="3">2 Designated Learning Institution # (O#)</td>
                <td class="tg-0pky">My Student ID # is: </td>
                <td class="tg-0pky">3 Duration of <br>expected study<br><br></td>
                <td class="tg-0pky">* From&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* To<br><br>YYYY-MM-DD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;YYYY-MM-DD</td>
            </tr>
            <tr>
                <td class="tg-0pky">4 The cost of my studies will be:<br>* Tuition</td>
                <td class="tg-0pky"><br>Room and board</td>
                <td class="tg-0pky"><br>Other</td>
                <td class="tg-0pky">5 *a) Funds available for my stay (CAD)</td>
                <td class="tg-0pky">* b) My expenses in Canada will be paid by: </td>
                <td class="tg-0pky">c) Other</td>
            </tr>
            <tr>
                <td class="tg-0pky" colspan="3">6 a) In addition to a study permit, are you also applying for a work permit? <img src="https://static.thenounproject.com/png/60253-200.png" alt="Image" width="35" height="35">No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="https://static.thenounproject.com/png/60253-200.png" alt="Image" width="35" height="35">Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td class="tg-0pky" colspan="3"> b) What type of work permit are you applying for?<br></td>
            </tr>
            <tr>
                <td class="tg-0pky" colspan="2">7 If you have been issued a Quebec Acceptance Certificate, provide the:<br>Certificate Number<br><br></td>
                <td class="tg-0pky" colspan="2"><br>Expiry Date<br><br></td>
                <td class="tg-0pky" colspan="2"></td>
            </tr>
            <tr>
                <td class="tg-fymr" colspan="6">If you are under the age of majority of the province/territory where you intend to study, you must fill out the Custodian Declaration [IMM 5646] form.</td>
            </tr>
        </tbody>
    </table>
    <b>EDUCATION</b>
