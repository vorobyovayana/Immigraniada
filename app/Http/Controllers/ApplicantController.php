...
class ApplicantController extends Controller
{
    ...
    function createWPApplicant(Request $postData)  {
        ...
        $na->englishExam= $postData->input('none');

        $na->passportNumber= $postData->input('passportNumber');
        $na->passportIssue= $postData->input('passportIssue');
        $na->passportExpiry= $postData->input('passportExpiry');
        $na->passportCountry= $postData->input('passportCountry');
    ...
    function createSPApplicant(Request $postData)  {
        ...
        $na->WorkPermitRequired= $postData->input('WorkPermitRequired');
